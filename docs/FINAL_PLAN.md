...
> **Archive.** The plan the sprint was executed against, kept unchanged as a
> record. Its "source of truth" line was true during the sprint; today the code on
> `main` is. See [AGENT_WORKFLOW.md](AGENT_WORKFLOW.md) for the outcome and
